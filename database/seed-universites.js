...
const { universites, filieresParUniversite } = require('./seeds/universites-seed');
const { campusesRowsForUniversite } = require('./seeds/campuses-seed');
const { ensureReferentielSousFilieresAll } = require('../includes/filiereReferentielSync');
