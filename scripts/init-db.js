...
const fs = require('fs');
const { universites, filieresParUniversite } = require('../database/seeds/universites-seed');
const { campusesRowsForUniversite } = require('../database/seeds/campuses-seed');
const { computeNewSousFilieres } = require('../includes/filiereReferentielSync');
